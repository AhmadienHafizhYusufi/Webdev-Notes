...
retain access to their lexical scope, even when the function is executed outside
of that scope.
...
- In this example, `init()` creates a local variable called `hobby` and a
  function called `displayHobby()`.
